    ...
    solveReCaptcha: async function(page) {
        ...
        return new Promise(
            (resolve, reject) => {
                ...
                const anticaptcha = require("./anticaptcha")("706bba143859e831430d020c0d2b4a38")
                anticaptcha.setWebsiteURL(page.url())
                anticaptcha.setWebsiteKey("GET YOUR KEY FORM https://anti-captcha.com/")
